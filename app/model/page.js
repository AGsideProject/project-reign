      ...
      <div ref={ref} className="flex justify-center flex-wrap gap-10 lg:gap-0 my-10">
        {images.map((item, index) => {
          return (
            ...
            //! parallax
            // <div
            //   className="w-3/4 md:w-72 lg:w-72 lg:mx-5 lg:mb-10 h-[75vh] bg-blue-500 overflow-hidden inline-block hover:shadow-custom-lg transition-shadow duration-300 shadow-black relative"
