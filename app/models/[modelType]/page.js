...
export default function models() {
  ...
  async function fetchModel() {
    try {
      ...
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/v1/model`
      );
  ...
  if (loading)
    return (
      <div className="h-screen w-screen bg-white backdrop-blur-glass"></div>
    );
          ...
          return (
            ...
            >
              ...
              <div className="relative aspect-[4/5] bg-white">
                ...
                >
                  <p className="text-sm md:text-xs xl:text-base 2xl:text-2xl ">
                    {" "}
                    HEIGHT: {item.hight} CM
                  </p>
